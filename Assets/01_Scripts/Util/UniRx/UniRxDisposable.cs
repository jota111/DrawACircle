...
{
    public sealed class SceneDisposable : AbstractDisposable
    {
        
    }
    
    public sealed class ObjectDisposable : AbstractDisposable
    {
        
    }

    public abstract class AbstractDisposable : ICollection<IDisposable>, IDisposable, ICancelable
    {
        ...
        public AbstractDisposable(int capacity)
        {
            if (capacity < 0)
        ...
        public AbstractDisposable(params IDisposable[] disposables)
        {
            if (disposables == null)
        ...
        /// <param name="disposables">Disposables that will be disposed together.</param>
        /// <exception cref="ArgumentNullException"><paramref name="disposables"/> is null.</exception>
        public AbstractDisposable(IEnumerable<IDisposable> disposables)
        {
            if (disposables == null)
                throw new ArgumentNullException("disposables");
